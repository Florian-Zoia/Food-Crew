            ...
            <View style={{
                ...
                <ScrollView horizontal={false} vertical={true}>
                    ...
                    <Text style={{
                       ...
                       Schritt 7: Gnocci in der Pfanne in etwas Olivenöl anbraten</Text>
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('ToDo8')}
                                      style={{
                                          width: '50%',
                                          height: '50%',
