        ...
        return (
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('ToDo4')}
                    >
                ...
                <ScrollView horizontal={false} vertical={true}>
                    ...
                    <Text style={{
                       ...
                       Schritt 5: Ein Drittel der Kräuter in ein hohes Gefäß geben</Text>
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('ToDo6')}
                                      style={{
                                          width: '50%',
                                          height: '50%',
